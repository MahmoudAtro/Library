                ...
                <ul>
                    ...
                    <li class="relative px-6 py-3">
                        <button
                            ...
                            @click="toggleCatigorieMenu" aria-haspopup="true">
                        ...
                        <div class="relative w-full max-w-xl mr-6 focus-within:text-purple-500">
                            ...
                            <form action="{{route("search")}}">
                              ...
                              <input
                                ...
                                type="text" placeholder="Search for Books" name="search" id="search"  onfocus="this.value=''" />
                            </form>
                        </div>
                    </div>
                    <ul class="flex items-center flex-shrink-0 space-x-6">
                        ...
                        <li class="relative">
                            <button class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none"
                                ...
                                aria-haspopup="true">
                                @if (!Auth::user()->img)
                                    <img class="object-cover w-15 h-15 rounded-full"
                          ...
                          width:30px; height:30px;" />
                                @else
                                    <img class="rounded-full w-20 h-20"
                                        src="{{ asset('images/' . Auth::user()->img) }}" alt="image description"
